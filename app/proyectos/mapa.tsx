...
const MapaProyectos = () => {
  ...
  // Función mejorada para calcular posición del tooltip
      ...
      <div className="flex flex-col lg:flex-row w-full max-w-7xl mx-auto gap-8 lg:gap-12 ">
        ...
        <div className="lg:w-2/3 relative h-[320px] lg:h-[550px] rounded-2xl   ">
          <div className="relative w-full h-full">
            ...
            {/* Contenedor para marcadores - z-index bajo */}
            ...
            {/* Contenedor para tooltips - z-index alto (POR ENCIMA de los marcadores) */}
          ...
          {/* Leyenda de Estado - z-index alto */}
        ...
        {/* Ficha Detalle móvil - z-index muy alto */}
        <AnimatePresence>
          {activeProject && (
            <motion.div
              initial={{ y: "100%" }}
