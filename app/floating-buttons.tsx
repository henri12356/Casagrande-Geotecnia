    ...
    <>
      ...
      <div className="hidden md:flex fixed bottom-6 right-6 flex-col space-y-4 z-50">
        ...
        <motion.div className="relative">
          <motion.button
            className="flex cursor-pointer items-center justify-center w-12 h-12 rounded-full shadow-lg text-white text-2xl bg-gray-700 hover:bg-gray-800 transition-all duration-300"
