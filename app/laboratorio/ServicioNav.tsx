// src/app/laboratorio/LaboratorioNav.tsx
"use client";
...
const LaboratorioNav = () => {
  ...
  const isActive = (slug: string) =>
    pathname === `/laboratorio/${slug}` ||
    pathname?.startsWith(`/laboratorio/${slug}/`);
    ...
    <div className="w-full bg-gradient-to-r from-gray-50 to-blue-50 border-b border-gray-200 -mt-1 relative z-10 py-7">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <h3 className="text-xs md:text-sm text-[#1b4772] font-bold mb-4 md:mb-6 uppercase tracking-wider text-center">
          Explorar Servicios de Laboratorio
        </h3>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-[1] flex items-center gap-3">
                    ...
                    <span
                      className={`text-[13px] font-semibold leading-snug ${active ? "text-white" : "text-[#1b4772]"} break-words`}
                      style={{
                        display: "-webkit-box",
                        WebkitLineClamp: 2,
