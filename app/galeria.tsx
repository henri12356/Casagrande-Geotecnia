          ...
          <CarouselContent>
            {serviciosData.map((servicio, index) => (
              ...
              >
                ...
                >
                  <Link href={servicio.href} className="flex flex-col h-full">
                    {/* Imagen */}
                    ...
                    <div className="flex flex-col flex-1 p-6">
                      ...
                      <button className="mt-auto flex items-center cursor-pointer text-[#1b4772] font-medium text-sm hover:text-gray-900 transition-colors">
