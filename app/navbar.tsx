...
const baseNavLinks: NavLink[] = [
  { href: "/", label: "Inicio" },
  {
    ...
    label: "Servicios",
    subLinks: [
      { href: "/servicios/geologia", label: "Estudios Geológicos" },
      { href: "/servicios/laboratorio-de-suelo", label: "Laboratorio de suelos" },
      { href: "/servicios/geotecnia", label: "Estudios Geotécnicos" },
      { href: "/servicios/geofisica", label: "Estudios Geofísicos" },
      { href: "/servicios/geomecanica", label: "Estudios Geomecánicos" },
      { href: "/servicios/hidrogeologia", label: "Estudios Hidrogeológicos" },
