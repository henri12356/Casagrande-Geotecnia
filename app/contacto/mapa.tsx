...
import ubicacionImg from '@/public/mapa.webp'; // Imagen de referencia
  ...
  return (
    <section className="w-full flex flex-col items-center px-4 py-20">
      ...
      <div className="relative w-full max-w-6xl rounded-xl overflow-hidden shadow-2xl">
        ...
        <div className="absolute  left-1/2 transform top-52 -translate-x-1/2 flex flex-col items-center z-10">
        <Link href="https://www.google.com/maps/place/Casagrande+Consultor%C3%ADa+y+Construcci%C3%B3n/@-13.1558258,-74.2216806,19z/data=!3m1!4b1!4m6!3m5!1s0x91127d8bfa4ecc4d:0x69dc04eda5da9649!8m2!3d-13.1558271!4d-74.2210355!16s%2Fg%2F11swgy9k3w?entry=ttu&g_ep=EgoyMDI1MDgzMC4wIKXMDSoASAFQAw%3D%3D" target="_blank" rel="noopener noreferrer">
          <div className=" p-3  hover:scale-105 transition transform">
            <Image 
              src={ubicacionImg} 
              alt="Ubicación Casagrande Geotecnia" 
              width={100} 
              height={100} 
              className="rounded-es-sm object-cover"
            />
          </div>
         </Link>
        </div>
