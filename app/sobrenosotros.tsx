        ...
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              ...
              ingeniería y construcción, especializada en{" "}
              <strong>
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              ...
              acreditado por <strong>INACAL</strong>, cuentan con
              certificaciones y calibraciones oficiales que respaldan la
              precisión de cada medición.
            </p>
            ...
            <a
              ...
              className="inline-block px-6 py-3 bg-[#182C45] text-white hover:text-[#182C45] font-semibold rounded-lg shadow-md hover:bg-[#C9A66B] transition duration-200 cursor-pointer"
            >
