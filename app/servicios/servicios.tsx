...
const Servicios = () => {
  return (
    <section className="py-10 px-4 md:px-6 max-w-7xl mx-auto">
      ...
      >
        <p className="text-[15px] md:text-xl text-gray-600 tracking-wide max-w-7xl mx-auto pt-4">
        ...
        <div className="border-t border-[#182C45]/20 mt-4"></div>
      ...
      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
        ...
        {servicios.map((servicio, index) => (
          ...
          >
            ...
            <Link href={servicio.link || `/servicios/${servicio.slug}`}>

              <Card className="relative shadow-lg rounded-2xl hover:shadow-2xl transition-all duration-500 overflow-hidden group h-80 cursor-pointer">
